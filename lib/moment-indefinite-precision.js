/*! Moment Indefinite Precision v0.4.0
...
(function (root) {
    ...
    moment.duration.fn.indefinitePrecision = function (format, cutoffs) {
        ...
        var msStr = this.milliseconds().toString().padStart(3, '0');
        var units = {
            years:    this.years(),
            months:   this.months(),
            days:     this.days(),
            ...
            seconds:  Number.parseFloat(`${this.seconds()}.${msStr}`),
        };
    ...
    moment.duration.indefiniteFromHuman = function (humanString) {
        ...
        if (Object.keys(durationProperties).length === 0) { return null; }
